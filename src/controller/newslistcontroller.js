...
exports.circularnewsList = async (req, res) => {
    try {
        // Assuming SelfNews is your Mongoose model
        const circularnews = await CircularNews.find() // Sort by latest published news

        // Return the list of news articles
        res.status(200).json({
            status: 'success',
            data: circularnews, // Return the fetched news data
        });
